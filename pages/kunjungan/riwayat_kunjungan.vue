            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-solid form-control-workpro border-0 one" placeholder="Masukkan nama tempat">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-medium">Keterangan <span class="text-danger">*</span></label>
                        <textarea class="form-control form-control-solid form-control-workpro-textarea border-0 one" rows="3" placeholder="Masukkan keterangan anda"></textarea>
                    </div>
                    <div class="mb-3">
